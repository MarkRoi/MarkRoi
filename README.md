...
I'm a passionate **Software Engineer** and **MSc Data Science** student at the University of Aberdeen, with a First Class Honors degree in Information Systems and Technology from Makerere University (CGPA 4.46). I specialize in building mobile apps, web systems, and innovative solutions that solve real-world problems. Currently based in Aberdeen, UK, I love blending creativity and tech to craft user-friendly experiences.

---

## 🔧 Skills

- **Languages**: Dart, Python, PHP, JavaScript, TypeScript, HTML/CSS, SQL, Wolfram Language
- **Frameworks & Libraries**: Laravel, Flutter, Drupal, React, Next.js, Tailwind CSS
- **Tools**: Git, GitHub, GitLab, Firebase, VS Code, Jupyter Notebooks, AWS
- **Integration**: REST APIs, JSON Handling, Database Management (SQL)
- **Soft Skills**: Project Management, Communication, Problem-Solving, Adaptability, Team Collaboration
...
- [View Project](https://github.com/MarkRoi/scikit-learn-housing)
...
#### [Silver Fleet App](https://play.google.com/store/apps/details?id=com.silverfleetltd.app)
...
- **Software Developer** @ New Wave Technologies Ltd (Sep 2022 - Jan 2025)  
  Built mobile and web solutions, improved client satisfaction by 20% through timely project delivery.

- **Sales Personnel** @ Retail Business (Dec 2019 - July 2022)  
  Managed sales processes and enhanced customer service.

- **Field Agent** @ Imara Mobile (May 2019 - Aug 2019)  
  Collected and analyzed data, optimizing inventory tracking.
...
- **Hobbies**: Art, Music, Sports, Learning, Traveling, Gaming
- **Qualities**: Honest, Creative, Team Player, Problem Solver
- **Languages**: English, Luganda

Feel free to explore my repos and reach out for collabs or opportunities—I’m always excited to build something impactful!
